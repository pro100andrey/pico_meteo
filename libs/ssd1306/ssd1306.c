...
inline static void ssd1306_write(ssd1306_t *const p, uint8_t val)
{
    uint8_t d[2] = {0x00, val};
    fancy_write(p->i2c_i, p->address, d, 2, "ssd1306_write");
}

bool ssd1306_init(ssd1306_t *const p, uint16_t width, uint16_t height, uint8_t address, i2c_inst_t *i2c_instance)
{
    p->width = width;
    p->height = height;
    p->pages = height / 8;
...
inline void ssd1306_deinit(ssd1306_t *const p)
{
    free(p->buffer - 1);
}

inline void ssd1306_power_off(ssd1306_t *const p)
{
    ssd1306_write(p, SET_DISP | 0x00);
}

inline void ssd1306_power_on(ssd1306_t *const p)
{
    ssd1306_write(p, SET_DISP | 0x01);
}

inline void ssd1306_contrast(ssd1306_t *const p, uint8_t val)
{
    ssd1306_write(p, SET_CONTRAST);
    ssd1306_write(p, val);
}

inline void ssd1306_invert(ssd1306_t *const p, uint8_t inv)
{
    ssd1306_write(p, SET_NORM_INV | (inv & 1));
}

inline void ssd1306_clear(ssd1306_t *const p)
{
    memset(p->buffer, 0, p->bufsize);
}

inline void ssd1306_clear_pixel(ssd1306_t *const p, uint32_t x, uint32_t y)
{
...
inline void ssd1306_draw_pixel(ssd1306_t *const p, uint32_t x, uint32_t y)
{
    if (x >= p->width || y >= p->height)
    {
        return;
...
void ssd1306_draw_line(ssd1306_t *const p, int32_t x1, int32_t y1, int32_t x2, int32_t y2)
{
    if (x1 > x2)
    {
        swap(&x1, &x2);
...
void ssd1306_clear_square(ssd1306_t *const p, uint32_t x, uint32_t y, uint32_t width, uint32_t height)
{
...
void ssd1306_draw_square(ssd1306_t *const p, uint32_t x, uint32_t y, uint32_t width, uint32_t height)
{
    for (uint32_t i = 0; i < width; ++i)
    {
        for (uint32_t j = 0; j < height; ++j)
...
void ssd1306_draw_empty_square(ssd1306_t *const p, uint32_t x, uint32_t y, uint32_t width, uint32_t height)
{
...
inline void ssd1306_draw_char_with_font(ssd1306_t *const p, uint32_t x, uint32_t y, uint32_t scale, const uint8_t *font, char c)
{
...
inline void ssd1306_draw_string_with_font(ssd1306_t *const p, uint32_t x, uint32_t y, uint32_t scale, const uint8_t *font, const char *s)
{
...
inline void ssd1306_draw_char(ssd1306_t *const p, uint32_t x, uint32_t y, uint32_t scale, char c)
{
    ssd1306_draw_char_with_font(p, x, y, scale, font_8x5, c);
}

inline void ssd1306_draw_string(ssd1306_t *const p, uint32_t x, uint32_t y, uint32_t scale, const char *s)
{
...
inline void ssd1306_bmp_show_image_with_offset(ssd1306_t *const p, const uint8_t *data, const long size, uint32_t x_offset, uint32_t y_offset)
{
...
inline void ssd1306_bmp_show_image(ssd1306_t *const p, const uint8_t *data, const long size)
{
    ssd1306_bmp_show_image_with_offset(p, data, size, 0, 0);
}

inline void ssd1306_show(ssd1306_t *const p)
{
