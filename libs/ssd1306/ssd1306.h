 ...
 */
bool ssd1306_init(ssd1306_t *const p,
                  uint16_t width,
                  uint16_t height,
                  uint8_t address,
 ...
 *
 */
void ssd1306_deinit(ssd1306_t *const p);
 ...
 *
 */
void ssd1306_power_off(ssd1306_t *const p);
...
*/
void ssd1306_power_on(ssd1306_t *const p);

/**
    @brief set contrast of display

    @param[in] p : instance of display
    @param[in] val : contrast (steps from 00h to FFh)

*/
void ssd1306_contrast(ssd1306_t *const p,
                      uint8_t val);
...
*/
void ssd1306_invert(ssd1306_t *const p,
                    uint8_t inv);
...
*/
void ssd1306_show(ssd1306_t *const p);
...
*/
void ssd1306_clear(ssd1306_t *const p);
...
*/
void ssd1306_clear_pixel(ssd1306_t *const p,
                         uint32_t x,
                         uint32_t y);
...
/**
    ...
    @param[in] y : y position
*/
void ssd1306_draw_pixel(ssd1306_t *const p,
                        uint32_t x,
                        uint32_t y);
...
*/
void ssd1306_draw_line(ssd1306_t *const p,
                       int32_t x1,
                       int32_t y1,
                       int32_t x2,
                       int32_t y2);
...
*/
void ssd1306_clear_square(ssd1306_t *const p,
                          uint32_t x,
                          uint32_t y,
                          uint32_t width,
                          uint32_t height);
...
/**
    ...
    @param[in] height : height of square
*/
void ssd1306_draw_square(ssd1306_t *const p,
                         uint32_t x,
                         uint32_t y,
                         uint32_t width,
                         uint32_t height);
...
/**
    ...
    @param[in] height : height of square
*/
void ssd1306_draw_empty_square(ssd1306_t *const p,
                               uint32_t x,
                               uint32_t y,
                               uint32_t width,
                               uint32_t height);
...
*/
void ssd1306_bmp_show_image_with_offset(ssd1306_t *const p,
                                        const uint8_t *data,
                                        const long size,
                                        uint32_t x_offset,
                                        uint32_t y_offset);
...
/**
    ...
    @param[in] size : size of image data in bytes
*/
void ssd1306_bmp_show_image(ssd1306_t *const p,
                            const uint8_t *data,
                            const long size);
...
*/
void ssd1306_draw_char_with_font(ssd1306_t *const p,
                                 uint32_t x,
                                 uint32_t y,
                                 uint32_t scale,
                                 const uint8_t *font,
...
/**
    ...
    @param[in] c : character to draw
*/
void ssd1306_draw_char(ssd1306_t *const p,
                       uint32_t x,
                       uint32_t y,
                       uint32_t scale,
                       char c);
...
*/
void ssd1306_draw_string_with_font(
    ssd1306_t *const p,
    uint32_t x,
    uint32_t y,
    uint32_t scale,
...
/**
    ...
    @param[in] s : text to draw
*/
void ssd1306_draw_string(ssd1306_t *const p,
                         uint32_t x,
                         uint32_t y,
                         uint32_t scale,
                         const char *s);
